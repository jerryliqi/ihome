...
_accountSid = '8a216da86e011fa3016e888f985f4d9c'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = 'b5a78a5ecd6e4ca896c6ce49bebb78fb'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da86e011fa3016e889163da4db0'
...
if __name__ == '__main__':
    ...
    CCP().send_sms_code('15563765325', ['123456', 5], 1)
