...
// http://127.0.0.1:5000/search.html?aid=1&aname=%E4%B8%9C%E5%9F%8E%E5%8C%BA&sd=2017-12-10&ed=
// 解析url中的查询字符串
        ...
        if ("0" == data.errno) {
            ...
            window.onscroll=function(){
                ...
                if(c-b<windowHeight+50){
                    // 如果没有正在向后端发送查询房屋列表信息的请求,那么就去查询数据，否则不查询
                    if (!house_data_querying) {
                        // 将正在向后端查询房屋列表信息的标志设置为真，代表在查询完成之前不再进行查询
